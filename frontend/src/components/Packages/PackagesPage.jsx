  ...
  .package-card {
    ...
    .pkg-info {
      ...
      .itinerary-preview {
        ...
        .days { display: flex; gap: 0; flex-wrap: wrap;
          .day { flex: 1; min-width: 100px; padding: 6px 10px; font-size: 12px; color: #5D4E37; border-left: 2px solid #E8E8E8; padding-left: 10px;
            strong { display: block; color: #8E44AD; font-size: 11px; margin-bottom: 2px; }
            &:first-child { border-left: 2px solid #8E44AD; }
          }
        }
      }
      ...
      .price-row {
        ...
        .book-btn { padding: 14px 32px; background: linear-gradient(135deg, #8E44AD, #C0392B); color: white; border: none; border-radius: 10px; font-size: 16px; font-weight: 700; cursor: pointer; transition: all 0.3s;
          &:hover { transform: translateY(-2px); box-shadow: 0 8px 25px rgba(142, 68, 173, 0.35); }
        }
      }
    }
  }
